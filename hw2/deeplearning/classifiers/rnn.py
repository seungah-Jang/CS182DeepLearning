...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        ############################################################################
        # 1. image features → initial hidden state (N, D) → (N, H)
        ...
        # 4. temporal affine: hidden state → vocab scores, (N, T, V)
    ...
    def sample(self, features, max_length=30):
        ...
        # (2) If using LSTM, initialize cell state to zero
        ...
        for t in range(max_length):
            # (4) Embed the current word
            word_embed = W_embed[current_word]  # (N, W)
            ...
            # (7) Choose the word with the highest score
